                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-container">
                            ...
                            <form method="POST" action="{{action('ContratosController@store')}}"   enctype="multipart/form-data"  role="form">
                                {{ csrf_field() }}
                                <div class="row">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4">
                                    ...
                                    <div class="form-group" >
                                        <label>Cópia do Contrato digitalizado</label>
                                    </div>
                                    <div class="form-group" >

                                    </div>
                                    <input type="file" name="contrato_digital" value="">
                                </div>
                                </div>
                                -->
                                <div class="row">
